...
# AUDIT FIX (muc 1 - Schema Registry): FILTER_COL_MAP gio derive truc tiep tu
# src/schema.py (Schema Registry duy nhat cua toan project) thay vi dinh nghia
# doc lap tai day. Truoc day co 2 ban sao co the lech nhau theo thoi gian;
# bay gio chi co 1 nguon su that. Gia tri khong doi -> khong anh huong runtime.
from src.schema import FILTER_TO_SCHEMA_COL as FILTER_COL_MAP
